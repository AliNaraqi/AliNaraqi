...
### 🛡️ [Real-Time Fraud Detection and Monitoring Platform](https://github.com/AliNaraqi/Real-Time-Fraud-Detection-and-Monitoring-Platform)

Cost-sensitive fraud modelling, FastAPI serving, SHAP explanations, MLflow tracking, Evidently drift monitoring, Kafka streaming, Prometheus, Grafana, Docker, CI, and automated tests.

### 📄 [DocMind — LLM-Powered PDF Q&A with RAG](https://github.com/AliNaraqi/DocMind-LLM-Powered-PDF-Q-A-with-RAG)
...
🚀 Open to opportunities in Data Science, Applied Machine Learning, ML Engineering, and Data Analytics.
